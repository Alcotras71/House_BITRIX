...
$('.btn-text-family').on('click', function(e) {
  imageEditor.changeTextStyle(activeObjectId, {fontFamily: 'Arial'})
});
...
$btnTextFamily.on('click', function(e) { // eslint-disable-line
  var styleType = $(this).attr('data-style-type');
  var styleObj;
...
$btnAddSantaMask.on('click', function() {
  imageEditor.addImageObject('./img/masks-pro/santa.png');
});
$btnAddNoseMask.on('click', function() {
  imageEditor.addImageObject('./img/masks-pro/nose.png');
});
$btnAddSnowmanMask.on('click', function() {
  imageEditor.addImageObject('./img/masks-pro/snowman.png');
});
$btnAddTreeMask.on('click', function() {
  imageEditor.addImageObject('./img/masks-pro/tree.png');
});

// characters
$btnAddSantamanMask.on('click', function() {
  imageEditor.addImageObject('./img/characters-pro/santaman.png');
});
$btnAddSnowmanfullMask.on('click', function() {
  imageEditor.addImageObject('./img/characters-pro/snowmanfull.png');
});
$btnAddBearMask.on('click', function() {
  imageEditor.addImageObject('./img/characters-pro/bear.png');
});
$btnAddDeerMask.on('click', function() {
  imageEditor.addImageObject('./img/characters-pro/deer.png');
});

// subjects
$btnAddBellMask.on('click', function() {
  imageEditor.addImageObject('./img/subjects-pro/bell.png');
});
$btnAddFlagsMask.on('click', function() {
  imageEditor.addImageObject('./img/subjects-pro/flags.png');
});
$btnAddGiftMask.on('click', function() {
  imageEditor.addImageObject('./img/subjects-pro/gift.png');
});
$btnAddCrhisttreeMask.on('click', function() {
  imageEditor.addImageObject('./img/subjects-pro/crhisttree.png');
});

// elements
$btnAddScarfMask.on('click', function() {
  imageEditor.addImageObject('./img/elements-pro/scarf.png');
});
$btnAddTextMask.on('click', function() {
  imageEditor.addImageObject('./img/elements-pro/text.png');
});
$btnAddBezelMask.on('click', function() {
  imageEditor.addImageObject('./img/elements-pro/bezel.png');
});
$btnAddSnowflakeMask.on('click', function() {
  imageEditor.addImageObject('./img/elements-pro/snowflake.png');
});
